...
tabs = st.tabs(["Overview", "Key Features", "Start AutoPilot"])
...
with tabs[0]:
    ...
    **AutoPilot** is a state-of-the-art machine learning application developed for the financial team at **The Children's Rescue Fund (CRF)**. 
    ...
    AutoPilot not only extracts the data but also provides **confidence scores** for each reading, allowing users to validate the accuracy of the captured information.
    """)
